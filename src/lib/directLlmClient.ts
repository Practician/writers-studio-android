...
- Пиши живой, неровный человеческий текст: чередуй короткие и длинные фразы без метронома; очень короткие предложения допустимы только там, где сцена сама их просит. Два соседних предложения не начинай одинаково.
